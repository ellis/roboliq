...
Let's consider some examples.  We'll use the `data1` table from above, shown again here in spread-sheet
format:
...
Directive    Result
-----------  -----------------
``data(): {where: 'source == "liquid1"'}}``  ``[{well: "A01", volume: "10 ul", source: "liquid1"}, {well: "A02", volume: "20 ul", source: "liquid1"}]``
------------------------------
...
which was already discussed above in the Data section.
