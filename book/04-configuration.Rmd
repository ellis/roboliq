...
CONTINUE: find resources for learning about HTN; there used to be documentation at http://danm.ucsc.edu/~wsack/Plan/abstract.html, but that page has disappeared.
...
It is a map from a object type to a function that accepts a named object and returns an array of predicates.  For example, here is Roboliq's converter for `Plate` objects:
