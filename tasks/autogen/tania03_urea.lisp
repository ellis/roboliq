(defproblem tania03_urea domain
 ; initial conditions
 (
  (is-agent r1)
  (is-agent user) ; user
  ...
  (model r1_bench_010x2 sm5)
  (model r1_bench_010x4 sm4)
  (model r1_bench_017x1 sm3)
  (model r1_bench_017x2 sm6)
  (model r1_bench_017x3 sm3)
  (model r1_bench_017x4 sm6)
  (model r1_bench_024x1 sm3)
  (model r1_bench_024x2 sm6)
  (model r1_bench_024x3 sm3)
  (model r1_bench_024x4 sm6)
  (model r1_bench_024x5 sm3)
  (model r1_bench_024x6 sm6)
  (model r1_bench_033x3 sm3)
  (model r1_bench_033x6 sm3)
  (model r1_bench_061x1 sm4)
  (model r1_device_126x1 sm6)
  (model r1_device_214x1 sm4)
  (model r1_device_234x1 sm3)
  (model r1_device_236x1 sm3)
  (model r1_device_237x1 sm3)
 ...
 ; tasks
 (
  (distribute3 ?a0001 ?d0002 spec0003 sourcePlate1 mixPlate sourcePlate2)
 )
)
