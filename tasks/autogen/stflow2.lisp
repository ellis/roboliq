(defproblem stflow2 domain
 ...
 (
  ...
  (is-model m001) ; Ellis Nunc F96 MicroWell
  (is-model m002) ; D-BSSE 96 Well DWP
  (is-model m003) ; D-BSSE 384 Well Plate White
  (is-model m004) ; D-BSSE 96 Well PCR Plate
  ...
  (is-plateModel m001) ; Ellis Nunc F96 MicroWell
  (is-plateModel m002) ; D-BSSE 96 Well DWP
  (is-plateModel m003) ; D-BSSE 384 Well Plate White
  (is-plateModel m004) ; D-BSSE 96 Well PCR Plate
  (is-sealer r1_sealer) ; RoboSeal
  (is-sealerSpec sealerSpec1)
  (is-shaker r1_shaker) ; MP 2Pos H+P Shake
  (is-shakerSpec shakerProgram1)
  ...
  (device-can-model r1_peeler m004)
  (device-can-model r1_sealer m004)
  (device-can-model r1_shaker m001)
  (device-can-model r1_shaker m002)
  (device-can-model r1_shaker m003)
  (device-can-model r1_shaker m004)
  (device-can-model r1_thermocycler1 m001)
  (device-can-model r1_thermocycler1 m004)
  ...
  (device-can-spec r1_shaker shakerProgram1)
  ...
  (model culture m001)
  (model dilution m001)
  (model r1_bench_009x1 sm4)
  (model r1_bench_009x2 sm7)
  (model r1_bench_010x1 sm4)
  (model r1_bench_010x2 sm6)
  (model r1_bench_010x4 sm2)
  (model r1_bench_017x1 sm4)
  (model r1_bench_017x2 sm7)
  (model r1_bench_017x3 sm4)
  (model r1_bench_017x4 sm7)
  (model r1_bench_024x1 sm4)
  (model r1_bench_024x2 sm7)
  (model r1_bench_024x3 sm4)
  (model r1_bench_024x4 sm7)
  (model r1_bench_024x5 sm4)
  (model r1_bench_024x6 sm7)
  (model r1_bench_033x3 sm5)
  (model r1_bench_033x6 sm5)
  (model r1_bench_061x1 sm2)
  (model r1_device_126x1 sm7)
  (model r1_device_214x1 sm2)
  (model r1_device_234x1 sm5)
  (model r1_device_236x1 sm4)
  (model r1_device_237x1 sm4)
  (model r1_device_65x1 sm1)
  (model r1_hotel_245x1 sm3)
  (model r1_hotel_245x10 sm3)
  (model r1_hotel_245x11 sm3)
  (model r1_hotel_245x12 sm3)
  (model r1_hotel_245x13 sm3)
  (model r1_hotel_245x14 sm3)
  (model r1_hotel_245x15 sm3)
  (model r1_hotel_245x16 sm3)
  (model r1_hotel_245x17 sm3)
  (model r1_hotel_245x18 sm3)
  (model r1_hotel_245x19 sm3)
  (model r1_hotel_245x2 sm3)
  (model r1_hotel_245x20 sm3)
  (model r1_hotel_245x21 sm3)
  (model r1_hotel_245x22 sm3)
  (model r1_hotel_245x23 sm3)
  (model r1_hotel_245x24 sm3)
  (model r1_hotel_245x25 sm3)
  (model r1_hotel_245x26 sm3)
  (model r1_hotel_245x27 sm3)
  (model r1_hotel_245x28 sm3)
  (model r1_hotel_245x29 sm3)
  (model r1_hotel_245x3 sm3)
  (model r1_hotel_245x30 sm3)
  (model r1_hotel_245x31 sm3)
  (model r1_hotel_245x32 sm3)
  (model r1_hotel_245x4 sm3)
  (model r1_hotel_245x5 sm3)
  (model r1_hotel_245x6 sm3)
  (model r1_hotel_245x7 sm3)
  (model r1_hotel_245x8 sm3)
  (model r1_hotel_245x9 sm3)
  (model r1_hotel_85x1 sm8)
  (model r1_hotel_85x2 sm8)
  (model r1_hotel_85x3 sm8)
  (model r1_hotel_85x4 sm8)
  (model r1_hotel_85x5 sm8)
  (model reaction m003)
  (model sourcePlate1 m002)
  ...
  (device-spec-can-model r1_peeler peelerSpec1 m004)
  (device-spec-can-model r1_sealer sealerSpec1 m004)
 ...
 (
  ...
  (shaker-run ?a0008 ?d0009 shakerProgram1 culture ?s0010)
  (distribute3 ?a0032 ?d0033 spec0034 culture dilution sourcePlate1)
  (distribute3 ?a0035 ?d0036 spec0037 sourcePlate1 reaction dilution)
 )
)
