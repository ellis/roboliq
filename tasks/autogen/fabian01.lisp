(defproblem fabian01 domain
 ...
 (
  ...
  (is-model m002) ; D-BSSE 384 Well Plate Black
  ...
  (is-plateModel m002) ; D-BSSE 384 Well Plate Black
  ...
  (device-can-model r1_peeler m003)
  (device-can-model r1_sealer m003)
  (device-can-model r1_shaker m001)
  (device-can-model r1_shaker m003)
  (device-can-model r1_thermocycler1 m003)
  ...
  (stackable sm7 m003)
  (model mixPlate m003)
  (model r1_bench_009x1 sm5)
  (model r1_bench_010x1 sm5)
  (model r1_bench_010x2 sm6)
  (model r1_bench_010x4 sm4)
  (model r1_bench_017x1 sm5)
  (model r1_bench_017x3 sm5)
  (model r1_bench_024x1 sm5)
  (model r1_bench_024x3 sm5)
  (model r1_bench_024x5 sm5)
  (model r1_bench_033x3 sm5)
  (model r1_bench_033x6 sm5)
  (model r1_bench_061x1 sm4)
  (model r1_device_126x1 sm2)
  (model r1_device_214x1 sm3)
  (model r1_device_234x1 sm5)
  (model r1_device_236x1 sm5)
  (model r1_device_237x1 sm5)
  (model r1_device_65x1 sm4)
  (model r1_hotel_245x1 sm7)
  (model r1_hotel_245x10 sm7)
  (model r1_hotel_245x11 sm7)
  (model r1_hotel_245x12 sm7)
  (model r1_hotel_245x13 sm7)
  (model r1_hotel_245x14 sm7)
  (model r1_hotel_245x15 sm7)
  (model r1_hotel_245x16 sm7)
  (model r1_hotel_245x17 sm7)
  (model r1_hotel_245x18 sm7)
  (model r1_hotel_245x19 sm7)
  (model r1_hotel_245x2 sm7)
  (model r1_hotel_245x20 sm7)
  (model r1_hotel_245x21 sm7)
  (model r1_hotel_245x22 sm7)
  (model r1_hotel_245x23 sm7)
  (model r1_hotel_245x24 sm7)
  (model r1_hotel_245x25 sm7)
  (model r1_hotel_245x26 sm7)
  (model r1_hotel_245x27 sm7)
  (model r1_hotel_245x28 sm7)
  (model r1_hotel_245x29 sm7)
  (model r1_hotel_245x3 sm7)
  (model r1_hotel_245x30 sm7)
  (model r1_hotel_245x31 sm7)
  (model r1_hotel_245x32 sm7)
  (model r1_hotel_245x4 sm7)
  (model r1_hotel_245x5 sm7)
  (model r1_hotel_245x6 sm7)
  (model r1_hotel_245x7 sm7)
  (model r1_hotel_245x8 sm7)
  (model r1_hotel_245x9 sm7)
  (model r1_hotel_85x1 sm1)
  ...
  (device-spec-can-model r1_peeler peelerSpec1 m003)
  (device-spec-can-model r1_sealer sealerSpec1 m003)
 ...
 (
  ...
  (sealer-run ?a0004 ?d0005 ?spec0006 mixPlate ?s0007)
 )
)
