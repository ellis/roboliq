(defproblem pe domain
 ...
 (
  ...
  (is-model m001) ; 96 Well PCR Plate- Roche
  (is-model m002) ; 96 Well PCR Plate
  (is-model m003) ; 96 Well DeepWell
  ...
  (is-plateModel m001) ; 96 Well PCR Plate- Roche
  (is-plateModel m002) ; 96 Well PCR Plate
  (is-plateModel m003) ; 96 Well DeepWell
  ...
  (model r1_bench_047x1 sm2)
  (model r1_bench_047x2 sm2)
  (model r1_bench_047x3 sm2)
  (model r1_device_213x1 sm3)
  (model r1_device_300x1 sm1)
  (model r1_device_301x1 sm3)
  (model r1_device_44x1 sm3)
  (model r1_device_44x2 sm3)
  (model r1_device_87x1 sm1)
  (model r1_hotel_225x1 sm4)
