...
(defproblem pa domain
 ...
 (
  ...
  (agent-has-arm r1 transportArm)
  (agent-has-pipetter r1 pipetter)
  ; robot r2
  (agent-is-active r2)
  (agent-has-arm r2 r2arm)
  (agent-has-sealer r2 sealer)
  ; robot 1 arm
  (arm-can-plateModel r1arm m1)
  (arm-can-site r1arm s1)
  ; robot 2 arm
  (arm-can-plateModel r2arm m1)
  (arm-can-site r1arm sealerSite)
  ; transport arm
  (arm-can-plateModel transportArm m1)
  (arm-can-site transportArm s1)
  (arm-can-site transportArm sealerSite)
  ; pipetter
