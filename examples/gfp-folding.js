...
var mdfxTemplate = _.template(fs.readFileSync(path.join(__dirname, "gfp-folding.mdfx.template")).toString());
	...
	return [
		{
			...
			items: [
				{ source: bufferSource, volume: "85.5ul", program: "Roboliq_Water_Dry_1000" },
				{ source: gfpSource, volume: "4.5ul", cleanBefore: "none", program: "Roboliq_Water_Wet_1000_mix3x50ul" }
			],
			clean: "thorough",
