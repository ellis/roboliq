...
class EvowareCompilerSpec extends FunSpec {
    ...
    steps:
      "1": {command: transporter._movePlate, agent: ourlab.mario.evoware, equipment: ourlab.mario.arm1, program: Narrow, object: plate1, destination: ourlab.mario.P3}
      "2": {command: transporter._movePlate, agent: ourlab.mario.evoware, equipment: ourlab.mario.arm1, program: Narrow, object: plate1, destination: ourlab.mario.P2}
    effects:
