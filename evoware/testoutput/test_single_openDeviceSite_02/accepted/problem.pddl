(define (problem X-problem)
  ...
  (:init
    ...
    (device-can-model mario__Centrifuge plateModel_384_square)
    ...
    (device-can-model mario__TRobot1 plateModel_96_nunc_transparent)
    (device-can-model mario__TRobot1 plateModel_96_pcr)
    ...
    (device-can-open-site mario__TRobot1 TROBOT1)
    ...
    (device-can-site mario__TRobot1 TROBOT1)
    ...
    (device-can-site mario__pipetter1 SYSTEM)
    ...
    (model CENTRIFUGE_1 sm8)
    (model CENTRIFUGE_2 sm8)
    (model CENTRIFUGE_3 sm8)
    (model CENTRIFUGE_4 sm8)
    (model P1 sm6)
    (model P2 sm3)
    (model P3 sm8)
    (model P4 sm13)
    ...
    (transporter-can mario__transporter1 TROBOT1 mario__transporterSpec0)
    ...
    (transporter-can mario__transporter2 TROBOT1 mario__transporterSpec0)
