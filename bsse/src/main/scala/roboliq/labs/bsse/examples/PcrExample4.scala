...
object ExampleRunner {
	val lLiquid = List[Liquid](
		...
		Liquid(key = "polymerase", physical = ("Glycerol"), cleanPolicy = ("TNT")),
		Liquid(key = "FRO114", cleanPolicy = ("DDD"), contaminants = ("DNA")),
		Liquid(key = "FRO115", cleanPolicy = ("DDD"), contaminants = ("DNA")),
		Liquid(key = "FRO699", cleanPolicy = ("DDD"), contaminants = ("DNA")),
		Liquid(key = "FRO700", cleanPolicy = ("DDD"), contaminants = ("DNA")),
		Liquid(key = "FRO703", cleanPolicy = ("DDD"), contaminants = ("DNA")),
		Liquid(key = "FRO704", cleanPolicy = ("DDD"), contaminants = ("DNA")),
		Liquid(key = "FRO1259", cleanPolicy = ("DDD"), contaminants = ("DNA")),
		Liquid(key = "FRO1260", cleanPolicy = ("DDD"), contaminants = ("DNA")),
		Liquid(key = "FRO1261", cleanPolicy = ("DDD"), contaminants = ("DNA")),
		Liquid(key = "FRO1262", cleanPolicy = ("DDD"), contaminants = ("DNA")),
		Liquid(key = "FRP128", cleanPolicy = ("DDD"), contaminants = ("DNA")),
		Liquid(key = "FRP222", cleanPolicy = ("DDD"), contaminants = ("DNA")),
		Liquid(key = "FRP332", cleanPolicy = ("DDD"), contaminants = ("DNA")),
		Liquid(key = "FRP337", cleanPolicy = ("DDD"), contaminants = ("DNA")),
		Liquid(key = "FRP446", cleanPolicy = ("DDD"), contaminants = ("DNA")),
		Liquid(key = "FRP572", cleanPolicy = ("DDD"), contaminants = ("DNA"))
	)
