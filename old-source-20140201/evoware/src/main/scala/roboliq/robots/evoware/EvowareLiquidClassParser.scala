...
import roboliq.entity.PipettePolicy
import roboliq.entity.PipettePosition
...
object EvowareLiquidClassParser {
	...
	def parseFile(filename: String): RqResult[List[PipettePolicy]] = {
		Try {
