(define (problem X-problem)
  ...
  (:init
    ...
    (model ROBOSEAL sm1)
    (model T3 sm3)
    (model plate1 plateModel_96_pcr)
    (model plate2 plateModel_384_square)
    (model plate3 plateModel_96_nunc_transparent)
    ...
    (stackable sm1 plateModel_96_pcr)
    (stackable sm2 plateModel_384_square)
    (stackable sm2 plateModel_96_dwp)
    ...
    (stackable sm7 troughModel_100ml)
