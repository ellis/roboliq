...
sealed class TipWell(val tip: Tip, val well: Well2) extends HasTip with HasWell {
...
sealed class TipWellPolicy(tip: Tip, well: Well2,
...
sealed class TipWellVolumePolicy(tip: Tip, well: Well2, volume: LiquidVolume,
		val policy: PipettePolicy
